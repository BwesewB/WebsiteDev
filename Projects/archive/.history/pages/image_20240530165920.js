...
export default function ImageSection() {
    useEffect(() => {
        ...
        timeline2.to(`.${styles.imageContainerImage}`, {
            clipPath: "polygon(0 100%, 100% 100%, 100% 100%, 0 100%)", // Fully hide the image initially
            duration: 0 // Set a very small duration to ensure initial clip path is applied instantly
        })
        .to(`.${styles.imageContainerImage}`, {
            clipPath: "polygon(0 100%, 100% 100%, 100% 0, 0 0)", // Clip from bottom to top
            duration: 1.5, // Animation duration
            ease: "power4.inOut", // Easing function
            delay: 0.5 // Delay the animation slightly to ensure the initial clip path is applied before the animation starts
        });
    }, []);
