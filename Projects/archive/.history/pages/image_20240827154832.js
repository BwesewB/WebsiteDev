    ...
    <>
      ...
      <main className={`${styles.main}`}>
        ...
        <div className={styles.imageContent}>
            ...
            <ImageAndText imageLink="/images/disc.jpg" width="14rem" height="14rem" top="320vh" left="30%" align="" alt="" number="20"/>
            <ImageAndText imageLink="/images/shilhouette.jpg" width="26rem" height="12rem" top="370vh" left="13%" align="" alt="" number="21"/>
            <ImageAndText imageLink="/images/verticalRed.jpg" width="40rem" height="40rem" top="350vh" left="60%" align="flex-end" alt="" number="22"/>
            <div className={styles.andNone}>
                <div style={{ width: "10rem", height: "10rem", position: "relative"}}>
                    <Image src="/images/plate.jpg" layout="fill"/>
                </div>
                <p className={styles.textular3}>and none</p>
            </div>

            <p className={styles.tweny3}>00.00.23</p>
