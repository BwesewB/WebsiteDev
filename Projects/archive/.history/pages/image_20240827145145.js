    ...
    <>
      ...
      <main className={`${styles.main}`}>
        ...
        <div className={styles.imageContent}>
            ...
            <ImageAndText imageLink="/images/closeHw.jpg" width="24rem" height="20rem" top="95vh" left="60%" align="flex-end" alt="" number="12"/>
            <ImageAndText imageLink="/images/reciptjpg" width="34rem" height="30rem" top="120vh" left="50%" align="" alt="" number="13"/>
