    ...
    <>
      ...
      <main className={`${styles.main}`}>
        ...
        <div className={styles.imageContent}>
            <ImageAndText imageLink="/images/mandarinHw.jpg" top="20vh" left="50%" width="45rem" height="30rem" alt="" align="flex-end" number="10"/>
            <ImageAndText imageLink="/images/bathroom.jpg" width="23rem" height="20rem" top="70vh" left="" align="" alt="" number=""/>
