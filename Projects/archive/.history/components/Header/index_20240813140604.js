...
import PageTransition from "@/components/preloaders/BarAnimation";
...
export default function Header({
    ...
    const handleClick = (e) => {
        ...
        if (!hasAnimated) {
            ...
            setHasAnimated(true); // Mark animation as occurred
            ...
            router.push('/video'); // If already animated, just navigate
        }
    };
