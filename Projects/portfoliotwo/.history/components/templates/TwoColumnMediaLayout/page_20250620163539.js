...
import styles from "./infoMediaLayout.module.css";
...
import AnimatedText from "@/components/molecules/AnimatedText/page";
...
const TextColumnContent = ({ textBlocks, buttons, inlineMedia, textColour }) => (
    <div className={styles.textContentWrapper} style={{ color: textColour }}>
        {textBlocks.map((block, index) => (
            <AnimatedText key={index} header={block.header} paragraph={block.paragraph} />
        ))}
