  ...
  useLayoutEffect(() => {
    if (isHomePage) {
      ...
      const animationContext = gsap.context(() => {
        ...
        // --- THE FINAL, ROBUST TIMELINE ---
        
        // Animate the font size first
        tl.to(h1, { 
            fontSize: "1rem", 
            duration: 0.6, 
            ease: "power2.inOut" 
        ...
        // Animate the letters collapsing. Start this at the same time as the font-size change.
        tl.to(lettersToHide, {
            opacity: 0,
            width: 0,
            minWidth: 0,
            ...
            // When the timeline reverses, completely remove these properties
            // from the inline style, allowing CSS to take over again.
            clearProps: "all" 
            
        }, "<"); // The "<" starts this tween at the same time as the previous one.

        // The ScrollTrigger is correct and remains the same.
