    ...
    <div className={styles.nameContainer}>
      <Link href="/">
        <h1 ref={h1Ref}>
          ...
          <span className="letter-hide"style={{border: "1px solid red"}}>a</span>
          <span className="letter-hide"style={{border: "1px solid red"}}>s</span>
          <span className="letter-hide"style={{border: "1px solid red"}}>t</span>
          <span className="letter-hide"style={{border: "1px solid red"}}>i</span>
          <span className="letter-hide"style={{border: "1px solid red"}}>a</span>
          <span className="letter-hide"style={{border: "1px solid red"}}>n</span>
          <span className="letter-hide"style={{border: "1px solid red"}}> </span>
