...
const DynamicHover = ({ 
  ...
  if (link) {
    // If there's a link, the <Link> component itself becomes our main container.
    return (
      <Link
        href={link}
  ...
  // If there's no link, a <div> is our main container.
  // This structure now mirrors the 'link' version perfectly.
  return (
    <div
      ref={containerRef}
      className={`${styles.dynamicHoverContainer} ${className}`}
