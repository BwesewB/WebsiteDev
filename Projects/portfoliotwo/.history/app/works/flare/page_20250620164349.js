...
import InfoMediaLayout from "@/components/templates/InfoMediaLayout/page";
...
export default function Flare({}) {
    ...
    return (
        <div className="container">
            ...
            />
            <InfoMediaLayout
                // Keep the text sticky, like in the original SectionSix
                stickyText={true}
                // The 'textBlocks' prop takes an array of header/paragraph objects
                textBlocks={[
                    { 
                ...
                // The 'buttons' prop takes your array of button data
                buttons={[
                    {
                        text: "WIREFRAME",
                        icon: "figma",
                ...
                // The 'mediaItems' prop takes an array of all your images/videos
                mediaItems={[
