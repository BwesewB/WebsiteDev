...
import LottieScrollTrigger from "@/components/atoms/LottieScrollTrigger/page";
...
export default function Flare({}) {
    return (
        <div className="container">
            ...
            <LottieScrollTrigger
                    style={{
                        display: 'block', // Use block instead of flex for this container
                        height: '30vh',   // Explicit height
                        width: '100%',
                        maxWidth: '500px',
                        margin: '8rem auto', // Center it and give it space
                        border: '3px solid blue' // A different color to confirm this style is applied
                    }}
                src="https://lottie.host/85233513-8392-4939-b26a-0ba65a228f09/35iI12iY2e.json"
            />
            <SectionSeven
