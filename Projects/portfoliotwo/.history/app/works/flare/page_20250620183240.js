    ...
    return (
        <div className="container">
            ...
            <TwoColumnMediaLayout
                textSide="right" // Main textBlocks will be on the right
                ...
                // buttons and inlineMedia here would also go to the right with textBlocks
                ...
                mediaColumnItems={[ // This content goes to the left column
                    ...
                    // If you had an image for the left column:
                    // { imageSrc: "/path/to/image.jpg" } 
                ]}
                
                stickyConfig={{ column: 'media' }} // The 'media' side (left here) will be sticky
            ...
            />
            <TwoColumnMediaLayout
                textSide="left" // Main textBlocks will be on the left
                ...
                buttons={[ // These buttons also go to the left column
                    {
                        text: "WIREFRAME",
                        icon: "figma",
                        externalLink: "..."
                ...
                mediaColumnItems={[ // This content goes to the right column
                ...
                stickyConfig={{ column: 'media' }} // The 'text' side (left here) will be sticky
