...
#@@@@@@#####%@@@@@@@#                        %@@@@*
 ...
 %@@@@@@@@@@@@@@@@@@@@@@@@@*              *@@@@@@# 
  ...
  const pageStyles = {
    ...
    "/works/taxes": { bgColor: "var(--sand)", navColor: "var(--blue)", textColor: "var(--sand)" },

    "/works/logo": { bgColor: "var(--sand)", navColor: "var(--blue)", textColor: "var(--sand)"  },
    "/works/deckedBeer": { bgColor: "var(--sand)", navColor: "var(--blue)", textColor: "var(--sand)"  },
    "/works/magazine": { bgColor: "var(--sand)", navColor: "var(--blue)", textColor: "var(--sand)"  },
    "/works/citadel": { bgColor: "var(--sand)", navColor: "var(--blue)", textColor: "var(--sand)"  },
    
    "/works/flare": { bgColor: "var(--sand)", navColor: "var(--blue)", textColor: "var(--sand)"  },
  };
