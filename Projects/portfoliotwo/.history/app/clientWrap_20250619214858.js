 ...
 %@@@@@@@@@@@@@@@@@@@@@@@@@*              *@@@@@@# 
  ...
  useEffect(() => {
    ...
    const smoother = ScrollSmoother.create({
      ...
      smooth: 0.7, // This is the equivalent of Lenis's "duration"
      ease: "power3.out", // This is the GSAP equivalent of your easing function
      smoothTouch: 0, // This disables smoothing on touch devices
    });
